...
interface WinnerWithCar extends WinnerType {
  name: string;
  color: string;
}
            ...
            <tr key={winner.id}>
              ...
              <td>
                ...
                >
                  ...
                  />
                  <path
                    d="M52.17,195.175c3.638,5.379,9.794,8.922,16.756,8.922c0.228,0,0.44-0.062,0.663-0.073c2.576-0.083,5.043-0.61,7.291-1.574
